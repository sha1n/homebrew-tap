...
| [acdc-mcp](https://github.com/sha1n/mcp-acdc-server) | [acdc-mcp](Casks/acdc-mcp.rb) | A Model Context Protocol (MCP) server that provides AI agents with searchable access to any markdown content through resources and an embedded full-text search tool. |
